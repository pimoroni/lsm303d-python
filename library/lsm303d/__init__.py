...
def setup():
    ...
    if _lsm303d.WHOAMI.get_id() != 0x49:
        raise RuntimeError("Unable to find lsm303d, WHOAMI returned {:02x}".format(_lsm303d.WHOAMI.get_id()))

    with _lsm303d.CONTROL1 as CONTROL1:
    ...
    with _lsm303d.CONTROL2 as CONTROL2:
        CONTROL2.set_accel_full_scale_g(2)
        CONTROL2.write()

    with _lsm303d.INTERRUPT1 as INT1:
    ...
    with _lsm303d.INTERRUPT2 as INT2: 
    ...
    with _lsm303d.CONTROL5 as CONTROL5:
        CONTROL5.set_mag_data_rate_hz(50)
        CONTROL5.set_enable_temperature(1)
        CONTROL5.write()

    with _lsm303d.CONTROL6 as CONTROL6:
        CONTROL6.set_mag_full_scale_gauss(2) # +-2
        CONTROL6.write()

def temperature():
    setup()
    return _lsm303d.TEMPERATURE.get_temperature() 
